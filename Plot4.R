...
plot(PowerDataSS$DateTime, PowerDataSS$Global_active_power, type = "l", ylab = "Global Active Power", xlab = "", mar = margins)

plot(PowerDataSS$DateTime, PowerDataSS$Voltage, type = "l", ylab = "Voltage", xlab = "datetime", mar = margins)

plot(PowerDataSS$DateTime, PowerDataSS$Sub_metering_1, type = "l", ylab = "Energy sub metering", xlab = "", mar = margins)
par(new=T)
...
plot(PowerDataSS$DateTime, PowerDataSS$Global_reactive_power, type = "l", ylab = "Global_reactive_power", xlab = "datetime", mar = margins)
